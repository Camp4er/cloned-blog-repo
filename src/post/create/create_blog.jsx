    ...
    <div className="flex flex-col justify-center items-center gap-3 my-28 pb-5">
      ...
      <div className="w-full flex items-center justify-center">
        ...
        >
          ...
          <button
            type="submit"
            className="flex items-center text-center justify-center w-fit p-1 self-end px-5 rounded-full border-2 font-bold text-lg bg-[var(--primary-color)] text-white transition-colors duration-300 disabled:bg-white disabled:text-slate-400 disabled:cursor-not-allowed"
          ...
          >
            {loading ? (
              <div className="flex items-center">
                ...
                <svg
                  className="animate-bounce duration-100 mr-1 h-2 w-2 text-white"
                ...
                <svg
                  className="animate-bounce duration-150 mr-1 h-2 w-2 text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#000"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className="animate-bounce duration-200 mr-1 h-2 w-2 text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#000"
                  viewBox="0 0 24 24"
                >
